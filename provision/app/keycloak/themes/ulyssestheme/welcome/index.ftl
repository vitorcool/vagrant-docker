...
<html>
<head>
    <title>Welcome to ${properties.productFullName}</title>
  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        <img src="${resourcesPath}/galp-logo-black-orange.png" alt="${properties.productFullName}" border="0" />
        <h1>Welcome to <strong>${properties.productFullName}</strong></h1>
      </div>
      <div class="row">
          ...
          <div class="card-pf h-l">
            ...
            <div class="welcome-primary-link">
              ...
              <div class="description">
                Centrally manage all aspects of the ${properties.productFullName} user-management server
              </div>
            </div>
          </div>
        </div>
        ...
        <#if properties.displayCommunityLinks = "true">
          <div class="card-pf h-m">
            <h3><a href="${properties.datacatalogUrl}"><img src="welcome-content/galp-project.png">${properties.productFullName} <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
          </div>
          <div class="card-pf h-m">
            <h3><a href="${properties.mailList}"><img src="welcome-content/mail.png">Mailing List <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
          </div>
          <div class="card-pf h-m">
            <h3><a href="${properties.bugReportUrl}"><img src="welcome-content/bug.png">Report an issue <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
          </div>
        </#if>
        </div>
      </div>
